    ...
    <nav className={className + " w-full flex gap-8 items-center px-12 bg-primary "}>
      <div className="">
        <ul className="flex gap-8 w-max text-xl items-center">
          <li><h3 className={"text-2xl tracking-wide text-white flex items-center " + russo.className}><span className="text-secondary">AU</span>TO<Image src={logo} className="w-12 h-12" />SLA<span className="text-secondary">VIA</span></h3></li>
          <li className="nav-link hidden lg:block"><Link href="/">Home</Link></li>
