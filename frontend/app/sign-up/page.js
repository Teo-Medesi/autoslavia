...
export default function SignUp() {
    ...
    return (
        <div className="w-full h-[90vh] bg-white md:bg-background flex justify-center items-center">
            <form action={handleSignUpWithEmail} className="w-full md:w-2/3 md:border-t-8 border-t-primary lg:w-1/2 xl:w-1/3 2xl:w-1/4 flex flex-col gap-12 justify-between padding-x padding-y-2 rounded-md bg-white aspect-4/5 md:shadow-md shadow-gray-2">
                {
                    !isSubmitted
                        ?
                        <>
                            ...
                            <button type="submit" className="btn-secondary !w-full !text-base">Sign Up</button>
                        ...
                        : !error
                            ...
                            <div className="w-full h-full flex justify-center items-center flex-col gap-12">
                                <Image src={zastava} className="w-3/4" alt="Jugo 45 car" />
                                <div className="text-center">
                                    <h1 className="text-2xl">Error while Signing Up!</h1>
