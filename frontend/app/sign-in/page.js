...
export default function SignIn() {  
    ...
    return (
        <div className="w-full h-[90vh] bg-white md:bg-background flex justify-center items-center">
            <form action={handleSignInWithEmail} className="w-full md:w-2/3 md:border-t-8 border-t-primary lg:w-1/2 xl:w-1/3 2xl:w-1/4 flex flex-col gap-12 justify-between padding-x padding-y-2 rounded-md bg-white aspect-4/5 md:shadow-md shadow-gray-2">
                ...
                <button type="submit" className="btn-secondary !w-full !text-base">Sign In</button>
